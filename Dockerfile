...
# docker build --progress=plain --tag jupyter:latest .
# docker run -ti -p 8888:8888 --rm jupyter:latest /bin/bash
# docker run -ti -p 8888:8888 --rm jupyter:latest
# docker run -ti -p 8888:8888 -v ${pwd}:/app --rm jupyter:latest
# docker run -ti -p 8888:8888 -v ${pwd}:/app --rm jupyter:latest /bin/bash
